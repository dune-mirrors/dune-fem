...
message(AUTHOR_WARNING "TODO. Verify PAPI checks")

set(PAPI_ROOT "" CACHE PATH "Path list to search for PAPI")

mark_as_advanced(PAPI_ROOT)

if(NOT CMAKE_DISABLE_FIND_PACKAGE_PAPI)
...
endif(NOT CMAKE_DISABLE_FIND_PACKAGE_PAPI)
