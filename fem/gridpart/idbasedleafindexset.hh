...
namespace Dune
{
   ...
   *
   *  \tparam  Grid  type of grid this index set is to be used for
   *
  ...
  template< class Grid >
  class IdBasedLeafIndexSet
  : public ConsecutivePersistentIndexSet< Grid, IdBasedLeafIndexSet< Grid > >
  {
    typedef IdBasedLeafIndexSet< Grid > ThisType;
    typedef ConsecutivePersistentIndexSet< Grid, ThisType > BaseType;
  ...
  public:
    ...
    static DUNE_DEPRECATED const int dim = GridType::dimension;
  ...
  public:
    ...
    int size ( GeometryType type ) const
    {
      ...
      return size( dimension - type.dim(), type );
    }
  ...
  template< class Grid >
  template< int codim >
  inline int IdBasedLeafIndexSet< Grid >::countElements ( GeometryType type ) const
  {
    typedef typename GridType::template Codim< codim >::template Partition< All_Partition >::Iterator
      IteratorType;
  ...
  template< class Grid > 
  inline void
  IdBasedLeafIndexSet< Grid >::print ( const char *msg, bool oldtoo ) const
  {
