...
static const int polOrd2 = 0;
//#include <dune/grid/io/file/dgfparser/dgfalu.hh>

#include <dune/grid/io/file/dgfparser/dgfs.hh>

#include <dune/fem/function/padaptivefunction.hh>
...
typedef PAdaptiveDiscreteFunction < DiscreteFunction1SpaceType, DiscreteFunction2SpaceType >DiscreteFunctionType;
...
public:
      ...
      double time, int polOrd) const
  {
    ...
    {
      // Get quadrature rule
      ElementQuadrature<GridPart2Type,0> quad2(*it2,10);
