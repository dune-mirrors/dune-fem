...
namespace Dune
{
  ...
  public:
    ...
    /** \copydoc Dune:LocalFunctionDefault::axpy(const DomainType &x,const JacobianRangeType &factor) */
    inline void axpy( const DomainType &x,
                      const JacobianRangeType &factor );

    /** \copydoc Dune:LocalFunctionDefault::axpy(const QuadratureType &quadrature,const int quadPoint,const JacobianRangeType &factor) */
    template< class QuadratureType >
    inline void axpy( const QuadratureType &quadrature,
                      const int quadPoint,
                      const JacobianRangeType &factor );
