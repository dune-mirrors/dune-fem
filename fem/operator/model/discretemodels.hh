...
namespace Dune {  
  ...
  template < class Model , class NumFlux , int polOrd
             , int passId1 = -1
             >
  class AdvDiffDModel3WithSource; // false,true,with source
  ...
  template< class Model,class NumFlux,int polOrd
             , int passId1 = -1
             >
  struct AdvDiffTraits3WithSource
  {
    typedef typename Model::Traits ModelTraits;
    typedef typename ModelTraits::GridType GridType;
    ...
    typedef AdvDiffDModel3WithSource<Model,NumFlux,polOrd
             , passId1
             > DiscreteModelType;
  }; //end of AdvDiffTraits3WithSource
...
//      const UType& argU = Element<0>::get(u);
  ...
  private:
    const Model& model_;
    const NumFlux& numflux_;
  }; //end of AdvDiffDModel3WithSource
  ...
  // shallow water discrete modelt traits, 
