...
namespace Dune {
  ...
  public:
                                                           ...
                                                           int order )
    {
      ...
      return QuadCreator< 0 > :: template provideQuad< CubeQuadratureType >
        ( geometry, order );
    }
  ...
  public:
                                                          ...
                                                          int order )
    {
      ...
      assert( order >= 0 );
      return QuadCreator< 0 > :: template provideQuad< PointQuadratureType >
        ( geometry, order );
    }
  ...
  public:
                                                          ...
                                                          int order )
    {
      assert( geometry.isCube() || geometry.isSimplex() );
      assert( order >= 0 );
      return QuadCreator< 0 > :: template provideQuad< LineQuadratureType >
        ( geometry, order );
    }
