...
ExplicitRungeKutta::ExplicitRungeKutta(const Communicator &comm, 
				       int num_of_stages, 
				       int order, 
				       Function &f) :
...
// class ExplicitEuler
ExplicitEuler::ExplicitEuler(const Communicator &comm, Function &f) : 
...
ExplicitModifiedEuler::ExplicitModifiedEuler(const Communicator &comm,
					     Function &f) : 
...
ExplicitTVD2::ExplicitTVD2(const Communicator &comm, Function &f) : 
  ExplicitRungeKutta(comm, 2, 2, f) {}
...
//class ExplicitTVD3
ExplicitTVD3::ExplicitTVD3(const Communicator &comm, Function &f) : 
...
ExplicitRK3::ExplicitRK3(const Communicator &comm, Function &f) : 
...
ExplicitRK4b::ExplicitRK4b(const Communicator &comm, Function &f) : 
...
//class ExplicitRK4
ExplicitRK4::ExplicitRK4(const Communicator &comm, Function &f) : 
  ExplicitRungeKutta(comm, 4, 4, f, RK4_A, RK4_b, RK4_c) {}
...
ExplicitButcher6::ExplicitButcher6(const Communicator &comm, Function &f) : 
