...
/********************************************************************
 * Problem:
 * Haufiger Aufruf von kleinen virtuellen Funktionen
 * (s. size test!). Das ist der Grund warum viele Leute sagen
 * OO Programmierung kann nie effizient sein.
 * Loesung:
