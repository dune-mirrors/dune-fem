...
namespace Dune {
  ...
  struct ForEachType {
    ...
    typedef Pair<typename TypeEvaluator<typename TupleType::Type1>::Type, 
                 typename ForEachType<TypeEvaluator, typename TupleType::Type2>::Type> Type;
  };
...
struct TupleToPair {
  typedef TupType ReturnType;
  static ReturnType convert(TupType tup) {return tup;}
  /*
