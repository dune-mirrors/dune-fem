...
/****************************************************
 * Problem: 
 * Die Rueckgabe eines Zeigers im Interface (Objekt
 * geht nicht direkt, da keine Instanz einer Klasse
 * mit pure virtuals angelegt werden kann).
 * Mit auto_ptr muss zwar kein delete aufgerufen werden
 * aber die Handhabung ist unschoen und in einer Schleife
 * staendig new/delete aufzurufen ist teuer!
 * Loesung:
 * Wrapper wie auto_ptr, der aber das 
 * Interface zur Verfuegung stellt und einen Stack
 * wo angelegte Pointer verwaltet werden koennen.
 ***************************************************/
