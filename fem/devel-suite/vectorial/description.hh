...
struct Descr
{
  ...
  typedef FunctionSpace < Field, Field , dim , 1 > FuncSpace1;
  typedef FunctionSpace<Field, Field, dim, dimRange> FuncSpace;
  typedef DofManager<GridType> DofManagerType;
  typedef LeafGridPart<GridType> GridPartType;
  typedef LagrangeDiscreteFunctionSpace<FuncSpace1,
                                        GridPartType,
                                        polOrd> FuncSpaceType1 ;
  typedef CombinedSpace<FuncSpaceType1, dimRange, PointBased> FuncSpaceType;
  //typedef DFAdapt < FuncSpaceType, DofManagerType > DiscreteFunctionType;
...
class TransportDescription 
{
  ...
  typedef typename DescrType::FuncSpaceType1 FuncSpaceType1;
...
public:
  ...
  TransportDescription ( const char * paramfile )
  {
    ...
    funcSpace1_ = new FuncSpaceType1( *gridPart_);
    funcSpace_ = new FuncSpaceType(*funcSpace1_);
