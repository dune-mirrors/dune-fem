...
template <class IndexSetImp, int polOrd, int dimrange>
class FiniteVolumeMapper
: public DofMapperDefault < FiniteVolumeMapper <IndexSetImp,polOrd,dimrange> > 
{
  enum { numCodims = IndexSetImp::ncodim };
...
public:
  ...
  //! Constructor 
  FiniteVolumeMapper (const IndexSetType & is, int numLocalDofs ) 
...
//! FiniteVolumeMapper for linear basefunctions  
template <class IndexSetImp, int dimrange>
class FiniteVolumeMapper<IndexSetImp,1,dimrange>
: public DofMapperDefault < FiniteVolumeMapper <IndexSetImp,1,dimrange> > 
{
  enum { numCodims = IndexSetImp::ncodim };
