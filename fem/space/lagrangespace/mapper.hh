...
namespace Dune
{
  ...
  class LagrangeMapper< GridPartImp, 1, 1 >
  : public DofMapperDefault< LagrangeMapper< GridPartImp, 1, 1 > >
  {
  public:
  ...
  public:
    ...
    {
      return indexSet_.template index< dimension >( entity, local );
    }
  ...
  #if 0
  template< class GridPartImp >
  class LagrangeMapper< GridPartImp, 2, 1 >
  : public DofMapperDefault< LagrangeMapper< GridPartImp, 2, 1 > >
  {
  public:
    typedef GridPartImp GridPartType;
  ...
  public:
    ...
    int mapToGlobal ( EntityType &entity, int local ) const
    {
      ...
      set->dofSubEntity( local, codim, subEntity );

      const int subIndex
        = indexSetCodimCall_[ codim ]->subIndex( indexSet_, entity, subEntity );
      return offset_[ codim ] + subIndex;
    }
