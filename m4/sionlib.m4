...
if test x$HAVE_SIONLIB = x1 ; then
  ...
  # add to global list
  DUNE_PKG_LDFLAGS="$DUNE_PKG_LDFLAGS $SIONLIB_LDFLAGS"
  DUNE_PKG_LIBS="$DUNE_PKG_LIBS $SIONLIB_LIBS"
  DUNE_PKG_CPPFLAGS="$DUNE_PKG_CPPFLAGS $SIONLIB_CPPFLAGS"
  ALL_PKG_LDFLAGS="$ALL_PKG_LDFLAGS $SIONLIB_LDFLAGS"
  ALL_PKG_LIBS="$ALL_PKG_LIBS $SIONLIB_LIBS"
  ALL_PKG_CPPFLAGS="$ALL_PKG_CPPFLAGS $SIONLIB_CPPFLAGS"
