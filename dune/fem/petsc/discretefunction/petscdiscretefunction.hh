...
#include <dune/fem/petsc/common/petscvector.hh>
#include <dune/fem/petsc/common/petsclocalfunction.hh>

#include <dune/fem/petsc/common/petscslavedofprovider.hh>
...
#endif // DUNE_FEM_PETSCDISCRETEFUNCTION_HH
