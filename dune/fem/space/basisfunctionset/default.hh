...
\endcode
    ...
    // Same as above but don't do any derivative transformation
    template< class Entity, class ShapeFunctionSet >
    class SimpleDefaultBasisFunctionSet
    {
      typedef SimpleDefaultBasisFunctionSet< Entity, ShapeFunctionSet > ThisType;
    ...
    public:
      ...
      //! \brief constructor
      SimpleDefaultBasisFunctionSet () {}

      //! \brief constructor
      explicit SimpleDefaultBasisFunctionSet ( const EntityType &entity, const ShapeFunctionSet &shapeFunctionSet = ShapeFunctionSet() )
        : entity_( &entity ),
          shapeFunctionSet_( shapeFunctionSet )
      {
        // Note that this should be geometry_ = entity.geometry()
      ...
      SimpleDefaultBasisFunctionSet ( const SimpleDefaultBasisFunctionSet &other )
        : entity_( other.entity_ ),
          shapeFunctionSet_( other.shapeFunctionSet_ )
      {
        // Note that this should be geometry_ = entity.geometry()
      ...
      SimpleDefaultBasisFunctionSet &operator= ( const SimpleDefaultBasisFunctionSet &other )
      {
        entity_ = other.entity_;
        shapeFunctionSet_ = other.shapeFunctionSet_;
      ...
      void axpy ( const Point &x, const HessianRangeType &hessianFactor, DofVector &dofs ) const
      {
        FunctionalAxpyFunctor< LocalHessianRangeType, DofVector > f( hessianFactor, dofs );
        shapeFunctionSet().hessianEach( x, f );
      }
