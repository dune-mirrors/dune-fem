...
namespace Dune
{
  ...
  namespace Fem
  {
    ...
    public:
      ...
      typedef Dune::ReferenceElement< typename EntityType::ctype, EntityType::Geometry::coordinatedim > ReferenceElementType;
      ...
      {
        return Dune::ReferenceElements< typename EntityType::ctype, EntityType::Geometry::coordinatedim >::general( entity().type() );
      }
