...
void traverse ( GridPartType &gridPart )
{
  ...
  GLQuadratureType glQuad( entity, 2*polorder-1 );
  GLQuadratureType gl2Quad( entity, 2*polorder );
#endif

  // needs a geometry type to construct
  typedef Dune::Fem::SelectCachingShapeFunctionSet < Dune::Fem::LagrangeShapeFunctionSet< ScalarFunctionSpaceType, polorder >, Storage > ScalarLagrangeShapeFunctionSetType;

  // needs an order to construct
  typedef Dune::Fem::SelectCachingShapeFunctionSet< Dune::Fem::LegendreShapeFunctionSet< ScalarFunctionSpaceType >, Storage > ScalarLegendreShapeFunctionSetType;

  // needs a geometry type to construct
  typedef Dune::Fem::SelectCachingShapeFunctionSet< Dune::Fem::OrthonormalShapeFunctionSet< ScalarFunctionSpaceType >, Storage > ScalarOrthonormalShapeFunctionSetType;
  ...
  typedef Dune::Fem::SelectCachingShapeFunctionSet< LocalFunctionsShapeFunctionSetType, Storage > ScalarLocalFiniteElementShapeFunctionSetType;
