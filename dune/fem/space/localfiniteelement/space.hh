...
namespace Dune
{
  ...
  namespace Fem
  {
    ...
    private:
      ...
      template< class T >
      struct HasTransformationType
      {
        typedef char yes;
        typedef long no;

        template< class C >
        static yes test( typename C::TransformationType* );
      ...
      template< class Entity, class ShapeFunctionSet, bool T >
      struct BasisFunctionSetChooser
      {
        typedef DefaultBasisFunctionSet< Entity, ShapeFunctionSet > Type;
      };

      template< class Entity, class ShapeFunctionSet >
      struct BasisFunctionSetChooser< Entity, ShapeFunctionSet, true >
      {
        typedef TransformedBasisFunctionSet< Entity, ShapeFunctionSet, typename LFEMapType::TransformationType > Type;
      };
...
//      typedef VectorialShapeFunctionSet< ShapeFunctionSetProxy< StoredShapeFunctionSetType >, typename FunctionSpaceType::RangeType > ShapeFunctionSetType;
      ...
      typedef typename BasisFunctionSetChooser< EntityType, ShapeFunctionSetType,
                                                HasTransformationType< LFEMapType >::value >::Type BasisFunctionSetType;
