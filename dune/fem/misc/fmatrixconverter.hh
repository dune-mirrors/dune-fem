...
namespace Dune
{
  ...
  struct DenseMatVecTraits< FieldMatrixConverter< FieldVector< K, n*m >, FieldMatrix< K, n, m > > >
  {
    typedef FieldMatrixConverter< FieldVector< K, n*m >, FieldMatrix< K, n, m > > derived_type;
    ...
    typedef FieldMatrixConverterRow< K, m > row_reference;
    typedef FieldMatrixConverterRow< K, m > const_row_reference;
  };
