#ifndef DUNE_FEM_SELECTION_HH
#define DUNE_FEM_SELECTION_HH
...
namespace Dune
{
  ...
  namespace Fem
  {
     ...
     * integral_constant and the end marker is mapped from -1 to Nil.
     */
...
#endif // #ifndef DUNE_FEM_SELECTION_HH
