...
from ufl import as_vector, dot, grad, cos, pi, SpatialCoordinate
from dune.grid import structuredGrid, gridFunction
from dune.fem.space import lagrange, composite, product
